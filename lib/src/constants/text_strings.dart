...
const String txtSigninWithGoogle = "Sign-in with google ";

const String txtForgetPassword = "Forget Password?";
const String txtDontHaveAccount = "Don't have an account?";

const String txtSignupTitle = "Get on board";

const String txtSignupSubtitle = "Create your profile to start journey with us";
const String txtAlreadyHaveAccount = "Don't have an account?";
...
const String txtDashboardSearch = "Search...";
const String txtBannerTitle = "Grocery . . .";
const String txtBannerSubtitle = "Jao hum nahi baichaty";

const String txtProfile = "Profile";
const String txtProfileHeading = "Profile Heading";
const String txtProfileSubHeading = "here is your Profile sub-Heading";
const String txtEditProfile = "Edit profile";

const String txtMenu = "Setting";